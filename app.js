...
// In serverless environments (Vercel), use /tmp since the filesystem is read-only
...
try {
    ...
    console.log('Uploads may not work correctly. Consider using cloud storage for production.');
}
