                ...
                // --- End Reset Glow Effect ---
                 ...
                 if (isArrowLine && vectorData.arrowSettings && strokePath.length >= 2) {
                     ...
                     if (lineLength > 0) {
                         ...
                         if (vectorData.arrowSettings.startArrow) {
                             drawArrowhead(ctx, startPoint.x, startPoint.y, -unitX, -unitY, scaledArrowSize, scaledArrowSize * 0.8, vectorData.color);
                         }
                         
                         // Draw end arrow if enabled
                         if (vectorData.arrowSettings.endArrow) {
                             drawArrowhead(ctx, endPoint.x, endPoint.y, unitX, unitY, scaledArrowSize, scaledArrowSize * 0.8, vectorData.color);
                         }
                     }
                 }
