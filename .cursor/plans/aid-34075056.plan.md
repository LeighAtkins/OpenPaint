...
- Update the worker to output prioritized `{code, stroke, confidence}` entries so the client can pre-populate A1–A4 and render ghost strokes without manual dropdown selection.
