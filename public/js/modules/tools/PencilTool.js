...
export class PencilTool extends BaseTool {
    ...
    onPathCreated(e) {
        ...
        if (pathLength < minStrokeLength) {
            console.log(`[PencilTool] Stroke too short (${pathLength.toFixed(1)}px < ${minStrokeLength}px) - removing`);
    ...
    calculatePathLength(path) {
        ...
        const diagonal = Math.sqrt(boundingRect.width * boundingRect.width + boundingRect.height * boundingRect.height);
        return diagonal;
    }
