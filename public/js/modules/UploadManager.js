...
export class UploadManager {
    constructor(projectManager) {
        ...
        this.heicWorkerUrl =
            window.HEIC_WORKER_URL ||
            document.body?.dataset?.heicWorkerUrl ||
            DEFAULT_HEIC_WORKER_URL;
    ...
    async handleFiles(fileList) {
        ...
        if (successCount) {
            this.showStatus(`Uploaded ${successCount} image${successCount > 1 ? 's' : ''} successfully.`, 'success');
        }
